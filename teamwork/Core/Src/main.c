...
int main(void)
{
  ...
  /* Initialize the LEDs. */
  LED_Init(&white_led,GPIOB,GPIO_PIN_0, 0);
  LED_Init(&user_led[0],GPIOA,GPIO_PIN_1, 0);
  LED_Init(&user_led[1],GPIOA,GPIO_PIN_2, 0);
  LED_Init(&user_led[2],GPIOA,GPIO_PIN_3, 0);
  LED_Init(&user_led[3],GPIOA,GPIO_PIN_4, 0);
